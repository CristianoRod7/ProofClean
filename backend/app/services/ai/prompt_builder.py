...
detections 항목 형식:
{{"id":"det-1","type":"EMAIL","label":"이메일 후보","confidence":0.8,"severity":"medium","description":"설명","evidence":"화면에 보이는 근거 또는 null","box":{{"x":0.1,"y":0.2,"width":0.3,"height":0.08}},"coordinateSpace":"normalized"}}
box는 이미지 전체를 0~1로 본 normalized 좌표로 반환하세요. 위치를 확실히 특정할 수 없으면 임의 좌표를 만들지 말고 box를 null로 반환하세요.
box가 null이면 coordinateSpace도 null로 반환하세요. 탐지 후보가 없으면 detections를 빈 배열로 반환하고 데모 항목을 만들지 마세요.
